...
***                                                                                            *
***     NTOE: Call series of macros that look for outcomegrp w/in specified days of an index   *
...
proc sql;
	...
	*Get information on the dates of prenatal encounters and indicators of encounter type (inpt, oupt, em, unkn);
...
;
	...
	*Get the IDs of people with prenatal encounters;
	...
	select distinct patient_deid, 1 as AnyPrenatal 
